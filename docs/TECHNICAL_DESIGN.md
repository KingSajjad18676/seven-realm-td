...
**Logic overview:** [GAME_LOGIC_AND_ESSENTIALS.md](GAME_LOGIC_AND_ESSENTIALS.md) · **Implementation truth:** [IMPLEMENTATION_STATUS.md](IMPLEMENTATION_STATUS.md) · [GODOT_PORT_STATUS.md](GODOT_PORT_STATUS.md)

## 1. Engine

**Active:** Godot 4.6 (GDScript, `.tres` resources, `.tscn` scenes) — project root `shahname-td-godot/shahname-td/`

**Archived reference:** Unity 2D / C# / ScriptableObjects under `_archive/unity/` (tag `unity-final-reference`)

Shared product constraints:

- Mobile landscape
- Data-driven content (Godot Resources; Unity used ScriptableObjects)
- Prefab/scene-based gameplay entities
...
## 1b. Engine (Unity — deprecated)

- Unity 2D, C#, ScriptableObject-driven content (see `_archive/unity/docs/UNITY_ARCHITECTURE.md`)
...
| `PremiumGateway` / `IAP.StubPurchaseProvider` | IAP stub — **deferred** for launch ([README_03](README_03_ETHICAL_MONETIZATION_BUSINESS.md)) |
