...
**Design canon:** [README_02_GAMEPLAY_VISUAL_UX_REPLAYABILITY.md](README_02_GAMEPLAY_VISUAL_UX_REPLAYABILITY.md) · [README_00_MASTER_PROJECT_INDEX.md](README_00_MASTER_PROJECT_INDEX.md)  
**Developer quick start:** [GAME_LOGIC_AND_ESSENTIALS.md](GAME_LOGIC_AND_ESSENTIALS.md)  
**What works today:** [IMPLEMENTATION_STATUS.md](IMPLEMENTATION_STATUS.md)

This document includes **advanced and post-launch** systems ported from Unity (rewind, tribute, premium stubs). **Khan 1 launch scope** is defined in README_02 §20 and [PRD.md](PRD.md) §5 — do not treat every section here as required for the first vertical slice.
...
- **Art still required:** regional overlay, brazier prop, hijack VFX — see [VISUAL_AND_VFX_SPEC.md](VISUAL_AND_VFX_SPEC.md)
...
**Next priority:** visual layer per [VISUAL_AND_VFX_SPEC.md](VISUAL_AND_VFX_SPEC.md) — gameplay logic is in place; readability at mobile scale depends on art.
