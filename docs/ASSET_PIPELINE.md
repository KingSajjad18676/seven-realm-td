...
**Design canon:** [README_01_PHASE_BASED_ASSET_GENERATION.md](README_01_PHASE_BASED_ASSET_GENERATION.md)  
**Readability checklist:** [VISUAL_AND_VFX_SPEC.md](VISUAL_AND_VFX_SPEC.md)  
**Active engine:** Godot 4.6 — `shahname-td-godot/shahname-td/art/_placeholders/`
...
Full prompt text and phase inventories: [README_01](README_01_PHASE_BASED_ASSET_GENERATION.md) · extract [_source/README_00_01_extracted.txt](_source/README_00_01_extracted.txt).
...
**Stable asset IDs** in `.tres` resources — gameplay must not guess filenames ([README_04](README_04_DEVELOPMENT_PRODUCTION_ROADMAP.md)).
...
Do not mass-produce Phase 2–7 assets before Khan 1 replay is proven ([README_00](README_00_MASTER_PROJECT_INDEX.md)).
...
Details: [VISUAL_AND_VFX_SPEC.md](VISUAL_AND_VFX_SPEC.md).

---

## 7. Unity import (archived reference)

Unity import rules for the archived project live under `_archive/unity/`. Use Godot import settings above for active work.
