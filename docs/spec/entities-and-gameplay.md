...
- **Genre:** Active 2D tower-defense roguelite, landscape mobile (Godot 4.6).
...
|----------------|---------------------|----------------------------|
| Barracks | Tent / gate, blocker units | `tower_barracks` |
...
| Art phase | `level_id` (gameplay) | `map_id` (art package) | Display name | Grid | Scale | `tileset_id` | Boss (campaign) | In repo |
|-----------|----------------------|--------------------------|--------------|------|-------|--------------|-----------------|---------|
...
| **1** | `level_01` | `map_khan_01_lion_rakhsh` | Khan 1 — Lion and Rakhsh | 32×18 | Medium | `tileset_woodland` | Lion of the First Khan | ✅ |
| **2** | `level_02` | `map_khan_02_desert_thirst` | Khan 2 — Desert of Thirst | 36×20 | Medium | `tileset_desert` | Manifestation of Thirst | ❌ |
| **2** | `level_03` | `map_khan_03_azhdaha_canyon` | Khan 3 — Azhdaha Canyon | 40×22 | Medium-large | `tileset_dragon_canyon` | Azhdaha | ❌ |
| **2** | `level_04` | `map_khan_04_sorceress_feast` | Khan 4 — Sorceress Feast | 42×24 | Medium-large | `tileset_enchanted_glade` | Sorceress (illusion + fiend) | ❌ |
| **2** | `level_05` | `map_khan_05_olad_camp` | Khan 5 — Olad Camp | 48×27 | Large | `tileset_mountain_camp` | Olad champion | ❌ |
| **2** | `level_06` | `map_khan_06_arzhang_fortress` | Khan 6 — Arzhang Fortress | 52×30 | Large | `tileset_div_fortress` | Arzhang Div | ❌ |
| **2** | `level_07` | `map_khan_07_white_div_cavern` | Khan 7 — White Div Cavern | 56×32 | Very large | `tileset_white_div_cavern` | Div-e Sepid | ❌ |
| **5** | `level_08_damavand` *(typical)* | `map_damavand_binding` | Damavand Binding (finale) | 64×36 | Very large | `tileset_damavand` | Zahhak binding sequence | ❌ logic gate only |
...
**Tower runtime (controllers):** level, hijack state, regional light efficiency, forge damage/range mult from `ForgeService`, targeting via `TowerController`.
