# Shahnameh TD — README 01: Phase-Based Asset Generation

**Last updated:** 2026-06-04  
**Design canon** — modular prompt system and production phases.  
**Related:** [ASSET_PIPELINE.md](ASSET_PIPELINE.md) · [VISUAL_AND_VFX_SPEC.md](VISUAL_AND_VFX_SPEC.md)  
**Full extract:** [_source/README_00_01_extracted.txt](_source/README_00_01_extracted.txt)
...
Every production asset uses a **stable asset ID** in data resources. Never guess filenames in gameplay code. See [README_04_DEVELOPMENT_PRODUCTION_ROADMAP.md](README_04_DEVELOPMENT_PRODUCTION_ROADMAP.md).
