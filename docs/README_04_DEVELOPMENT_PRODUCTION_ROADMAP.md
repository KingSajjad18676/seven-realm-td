# Shahnameh TD — README 04: Development and Production Roadmap

**Last updated:** 2026-06-04  
**Design canon** — Godot 4.6 mobile implementation plan.  
**Implementation truth:** [GODOT_PORT_STATUS.md](GODOT_PORT_STATUS.md) · [GODOT_ARCHITECTURE.md](GODOT_ARCHITECTURE.md)  
...
Align actual repo layout with [GODOT_ARCHITECTURE.md](GODOT_ARCHITECTURE.md) as the port evolves.
...
**Primary signal before M7:** voluntary Khan 1 replay (see [README_00](README_00_MASTER_PROJECT_INDEX.md)).
