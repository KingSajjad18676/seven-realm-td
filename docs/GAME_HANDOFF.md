# Shahnameh TD — Game Handoff

**Last updated:** 2026-06-04  
**Audience:** New designers, programmers, artists, or collaborators  
**Purpose:** One document to understand **what the game is**, **how it plays**, and **how the code implements it**.

**Design canon:** [DOC_INDEX.md](DOC_INDEX.md) → [README_00](README_00_MASTER_PROJECT_INDEX.md) · [README_02](README_02_GAMEPLAY_VISUAL_UX_REPLAYABILITY.md)  
**Implementation truth:** [GODOT_PORT_STATUS.md](GODOT_PORT_STATUS.md) · [IMPLEMENTATION_STATUS.md](IMPLEMENTATION_STATUS.md) (design target vs built today)

**Active engine:** Godot 4.6 — `shahname-td-godot/shahname-td/` (F5 boot)  
**Unity reference (archived):** `_archive/unity/` — do not edit unless comparing parity

**First production target:** Khan 1 vertical slice only until testers **voluntarily replay** ([README_00](README_00_MASTER_PROJECT_INDEX.md)).
...
| 3 | **MainMenu** | Play Campaign → World Map; toolbar opens meta panels (Hero, Towers, Relics, Daily, Bazaar, Quests, Forge, etc.). Premium/Battle Pass UI may exist as **stubs** — not launch monetization ([README_03](README_03_ETHICAL_MONETIZATION_BUSINESS.md)). |
...
Rostam’s seven labors plus a finale binding map ([README_02](README_02_GAMEPLAY_VISUAL_UX_REPLAYABILITY.md)):
...
repo root/
  ...
  art/_placeholders/
  tools/                 validate_resources.ps1, smoke_test.gd, Unity importers
  docs/                  Design specs (this file + others)
  _archive/unity/        Historical C# reference only
```
...
See [GODOT_PORT_STATUS.md](GODOT_PORT_STATUS.md) for the live checklist.
...
|----------|----------------|
| [PRD.md](PRD.md) | Product vision, MVP vs full launch |
| [GAMEPLAY_SPEC.md](GAMEPLAY_SPEC.md) | Complete design rules (full target spec) |
| [GAME_LOGIC_AND_ESSENTIALS.md](GAME_LOGIC_AND_ESSENTIALS.md) | Developer deep-dive (Unity paths + extended detail) |
| [GAMEPLAY_AND_ASSET_REQUIREMENTS.md](GAMEPLAY_AND_ASSET_REQUIREMENTS.md) | Player flow + asset checklist |
| [GODOT_ARCHITECTURE.md](GODOT_ARCHITECTURE.md) | Folders, autoloads, Unity→Godot mapping |
| [GODOT_PORT_STATUS.md](GODOT_PORT_STATUS.md) | What is implemented vs partial |
| [VISUAL_AND_VFX_SPEC.md](VISUAL_AND_VFX_SPEC.md) | Art direction and readability |
| [TECHNICAL_DESIGN.md](TECHNICAL_DESIGN.md) | Scenes, managers, save fields |
