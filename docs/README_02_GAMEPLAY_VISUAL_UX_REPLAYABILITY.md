# Shahnameh TD — README 02: Gameplay, Visual UX, and Replayability

**Last updated:** 2026-06-04  
**Design canon** — senior game-design specification.  
**Implementation truth:** [IMPLEMENTATION_STATUS.md](IMPLEMENTATION_STATUS.md) · [GAMEPLAY_SPEC.md](GAMEPLAY_SPEC.md)  
**Source:** `Shahnameh TD Gameplay Design.pdf` (extract: [\_source/README_02_extracted.txt](_source/README_02_extracted.txt))
