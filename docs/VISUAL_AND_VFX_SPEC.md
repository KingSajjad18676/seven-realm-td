...
**Design canon:** [README_01_PHASE_BASED_ASSET_GENERATION.md](README_01_PHASE_BASED_ASSET_GENERATION.md) · [README_02_GAMEPLAY_VISUAL_UX_REPLAYABILITY.md](README_02_GAMEPLAY_VISUAL_UX_REPLAYABILITY.md)
...
**Art direction:** Hand-painted Shahnameh / Persian miniature — strong dark contours, painterly cel-shading, bronze/teal/crimson/ivory palette, warm-orange Sacred Fire accents, restrained cold-violet corruption. See [ASSET_PIPELINE.md](ASSET_PIPELINE.md) for import and prompt workflow.

**Khan 1 priority VFX IDs:** `vfx_sacred_fire_cleanse`, `vfx_region_corruption_stage_01`, `vfx_tower_hijack_start`, `vfx_arrow_release`, `vfx_arrow_impact` (README_01 Phase 1).
...
- Layer: `HijackedTower` (Unity layer) for targeting/debug.
...
## 8. Unity layers & tags (project setup)
...
- [GAMEPLAY_SPEC.md](GAMEPLAY_SPEC.md) — rules and math
- [ASSET_PIPELINE.md](ASSET_PIPELINE.md) — AI generation and import
- [DEVELOPMENT_ROADMAP.md](DEVELOPMENT_ROADMAP.md) — Phase 5.6 visual polish
